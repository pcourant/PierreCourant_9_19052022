...
export default class NewBill {
  ...
  handleChangeFile = e => {
    ...
    const regexJPGorPNG = /^.*\.(jpg|JPG|jpeg|JPEG|png|PNG)$/
    if (!fileName.match(regexJPGorPNG)) {
      fileElement.value=''
      fileElement.setCustomValidity("Erreur de format. Seuls les fichiers jpg ou png sont acceptés.")
